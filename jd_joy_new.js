...
function beforeTask(shopId) {
  return new Promise(resolve => {
    $.get({
      url: `https://jdjoy.jd.com/common/pet/icon/click?iconCode=follow_shop&linkAddr=${shopId}&reqSource=h5&invokeKey=NRp8OPxZMFXmGkaE`,
      headers: {
        'Accept': '*/*',
        'Connection': 'keep-alive',
        'Content-Type': 'application/json',
